...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/ecsutil v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sconfig v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.87.0-fn.patch.1

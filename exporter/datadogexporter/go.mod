...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/ecsutil v0.82.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.82.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sconfig v0.82.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.82.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.82.0-fn.patch.1

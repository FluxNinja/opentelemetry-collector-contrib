...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/ecsutil v0.80.0-fn.patch.3
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.80.0-fn.patch.3
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sconfig v0.80.0-fn.patch.3
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.80.0-fn.patch.3
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.80.0-fn.patch.3

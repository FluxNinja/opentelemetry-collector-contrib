...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/filter v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/ottl v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.87.0-fn.patch.1

...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.82.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheus v0.82.0-fn.patch.1

...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.79.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheus v0.79.0-fn.patch.1

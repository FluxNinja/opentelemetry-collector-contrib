...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.80.0-fn.patch.4
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheus v0.80.0-fn.patch.4

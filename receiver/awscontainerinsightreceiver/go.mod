...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/awsutil v0.90.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/containerinsight v0.90.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/k8s v0.90.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/metrics v0.90.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sconfig v0.90.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kubelet v0.90.0-fn.patch.1

...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kafka v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/jaeger v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/zipkin v0.87.0-fn.patch.1

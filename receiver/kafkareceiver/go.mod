...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kafka v0.91.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/azure v0.91.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/jaeger v0.91.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/zipkin v0.91.0-fn.patch.1

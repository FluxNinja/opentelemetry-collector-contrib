...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kafka v0.93.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/azure v0.93.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/jaeger v0.93.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/zipkin v0.93.0-fn.patch.1

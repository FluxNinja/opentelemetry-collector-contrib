...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8stest v0.80.0-fn.patch.4
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata v0.80.0-fn.patch.4
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.80.0-fn.patch.4
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/opencensus v0.80.0-fn.patch.4

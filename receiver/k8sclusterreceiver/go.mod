...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8stest v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sharedcomponent v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata v0.87.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.87.0-fn.patch.1

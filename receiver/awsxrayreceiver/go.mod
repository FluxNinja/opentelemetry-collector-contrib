...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/proxy v0.80.0-fn.patch.2
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/xray v0.80.0-fn.patch.2

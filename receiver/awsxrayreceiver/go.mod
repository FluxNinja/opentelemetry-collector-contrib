...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/proxy v0.93.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/xray v0.93.0-fn.patch.1

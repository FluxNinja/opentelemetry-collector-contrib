...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.90.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.90.0-fn.patch.1

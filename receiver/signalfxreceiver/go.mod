...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.80.0-fn.patch.3
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.80.0-fn.patch.3
